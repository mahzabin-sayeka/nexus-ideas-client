...
// const ideas = [
//   { id: 1, title: "AI Mental Health Chatbot", cat: "AI" },
//   { id: 2, title: "Smart Healthcare Wearable", cat: "Health" },
//   { id: 3, title: "Blockchain Supply Chain", cat: "Tech" },
// ];
...
//           <div key={idea.id} className="p-6 border rounded-2xl shadow-sm hover:shadow-md transition">
//             <h3 className="text-xl font-bold">{idea.title}</h3>
//             <p className="text-slate-500 mt-2">{idea.cat}</p>
//           </div>
//         ))}
//       </div>
//     </main>
...
import IdeasFilter from '@/components/IdeasFilter';
import Link from 'next/link'; // for link button
